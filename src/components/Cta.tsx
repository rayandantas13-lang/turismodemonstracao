            ...
            <div className="relative flex flex-col lg:flex-row lg:items-center gap-10">
              <div className="max-w-2xl">
                <p className="font-mono text-[11px] font-bold tracking-[0.24em] text-mint/70 uppercase mb-4">
                  Última chamada · embarque BPS → Paraíso
                </p>
                <h2 className="font-display uppercase text-4xl sm:text-6xl leading-[0.95] text-white">
                  Pronto pra
                  <br />
                  <span className="text-tropic">viver Porto?</span>
                </h2>
                <p className="mt-5 text-mint/85 text-lg max-w-lg">
                  Manda um “oi” agora e já te mando roteiro com valores fechados pra Arraial, Trancoso, Caraiva e Coroa Vermelha + jetski, quadriciclo e mergulho. <strong className="text-white">Buscamos no aeroporto e no hotel. Tudo incluso.</strong>
                </p>
                <div className="mt-6 flex flex-wrap gap-2">
                  <span className="font-mono text-[10px] uppercase border border-white/20 rounded-full px-3 py-1.5 text-white/80">🚐 Busca no hotel inclusa</span>
                  <span className="font-mono text-[10px] uppercase border border-white/20 rounded-full px-3 py-1.5 text-white/80">🌴 Guia local 24h</span>
                  <span className="font-mono text-[10px] uppercase border border-white/20 rounded-full px-3 py-1.5 text-white/80">💬 Fecha direto no WhatsApp</span>
                </div>
              </div>
              ...
              <div className="lg:ml-auto flex flex-col items-start gap-4">
                ...
                <p className="font-mono text-[10px] tracking-[0.2em] text-mint/60 uppercase">
                  Resposta em minutos · sem robô · direto com guia local
                </p>
              </div>
            </div>
          </div>

const OFFERS = [
  "ARRAIAL D'AJUDA — MUCUGÊ + PITINGA + LAGOA AZUL",
  "TRANCOSO — QUADRADO + PRAIA DO ESPELHO + 4X4",
  "CARAIVA — RIO + MAR + BUGGY + QUADRICICLO",
  "COROA VERMELHA + ALDEIA PATAXÓ — IMERSÃO CULTURAL",
  "RECIFE DE FORA — MERGULHO CILINDRO + FOTOS SUB",
  "JETSKI + LANCHA PRIVATIVA + DRONE",
  "TRANSFER BPS ↔ HOTEL + BUSCA DIÁRIA NO HOTEL",
  "FECHA NO WHATSAPP — PACOTE COMPLETO",
];

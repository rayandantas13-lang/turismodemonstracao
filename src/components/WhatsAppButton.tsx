...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="wa-pulse fixed bottom-5 right-5 sm:bottom-7 sm:right-7 z-50 inline-flex items-center gap-2.5 rounded-full bg-tropic text-abyss font-bold pl-4 pr-5 py-4 hover:bg-azure hover:text-white transition-all duration-300 hover:scale-105 shadow-2xl shadow-black/40"
    >

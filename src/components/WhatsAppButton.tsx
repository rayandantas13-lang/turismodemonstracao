...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="wa-pulse fixed bottom-4 right-4 sm:bottom-7 sm:right-7 z-50 inline-flex items-center gap-2 rounded-full bg-tropic text-abyss font-bold pl-3 pr-4 py-3 sm:pl-4 sm:pr-5 sm:py-4 hover:bg-azure hover:text-white transition-all duration-300 hover:scale-105 shadow-2xl shadow-black/40"
    >
      ...
      <span className="text-sm leading-none">
        WhatsApp
        <span className="hidden sm:block font-mono text-[9px] tracking-widest opacity-70 mt-0.5">
          online agora
        </span>
      </span>
    </a>
